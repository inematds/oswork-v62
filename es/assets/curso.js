...
(function(){
  ...
  var L={"lido": "leído", "concluida": "concluida ✓", "andamento": "en curso", "comecar": "comenzar →", "continuar": "Continuar desde donde lo dejaste", "comecarCurso": "Comenzar por la lección 1", "revisao": "Revisar", "aula": "Lección", "revisarN": "revisar {n}", "aulasConcluidas": "lecciones concluidas", "faltam": "para terminar", "min": "min", "dica": "Consejo: el botón <b>Aa</b> aumenta el tamaño de la letra. Tu progreso se guarda solo en este navegador.", "entendi": "entendí", "promessa": "Al final de esta lección", "fechoTit": "Cerrar la lección", "fechoTxt": "En una frase: ¿qué de esta lección vas a usar primero en tu trabajo? (opcional, solo para ti)", "concluir": "concluir lección", "concluidaTit": "Lección concluida.", "concluidaTxt": "{n} preguntas de esta lección fueron a <b>revisar</b>. Vuelven solas en los próximos días, en el momento justo de acordarte.", "salvo": "Tu progreso se guardó.", "revisarAgora": "revisar ahora", "refazer": "repetir la práctica", "mostrar": "mostrar respuesta", "deNovo": "me equivoqué", "bom": "me acordé", "facil": "fácil", "nadaRevisar": "Nada para revisar ahora. Las preguntas vuelven solas en los próximos días.", "menu": "Menú", "trilhas": "Rutas", "trilhasSub": "elegir el módulo", "jornada": "Mi recorrido", "exercicios": "Prácticas del curso", "tema": "Tema", "idioma": "Idioma", "temas": {"papel": "papel", "escuro": "oscuro", "sepia": "sepia"}, "tamanho": "Tamaño de la letra", "entrelinha": "Espacio entre líneas", "restaurar": "restaurar el valor predeterminado", "fechar": "cerrar", "menor": "menor", "maior": "mayor", "menos": "menos", "mais": "más", "jProg": "Progreso", "jCap": "Lo que ya puedes hacer", "jCapVazio": "Aún no has completado ninguna lección: todo bien, una cosa a la vez.", "jTempo": "Tiempo", "investido": "invertido", "restante": "restante", "jGrifos": "Tus resaltados", "jSemGrifo": "Aún no hay ningún resaltado. Selecciona un fragmento del texto para resaltarlo.", "jPend": "sin prisa — {n} preguntas esperándote", "jPend0": "nada esperándote ahora", "jFim": "Completaste toda la ruta. Lo que estaba en el papel ahora está en tu trabajo.", "capRe": "^(al final de esta lección,? )?(ya )?(puedes|podrás|tienes|tendrás) ", "exportar": "guardar mi progreso (.json)", "importar": "recuperar el progreso guardado", "zerar": "reiniciar todo", "zerarQ": "¿Borrar todo tu progreso de este curso?", "arqInv": "Archivo inválido.", "irAte": "ir hasta ella", "resetar": "rehacer", "feito": "hecho", "pendente": "pendiente", "grifar": "resaltar", "grifarCartao": "resaltar + pregunta", "novoCartao": "Nueva pregunta de revisión", "frente": "Pregunta", "verso": "Respuesta", "ceHint": "Escribe como <b>pregunta</b>: recordar solo fija más que releer.", "salvar": "guardar", "cancelar": "cancelar", "copiar": "copiar", "copiado": "copiado ✓", "certo": "Correcto.", "quase": "Casi.", "aCerta": "La opción correcta está marcada.", "exemplo": "En la práctica", "compare": "Toca para comparar los dos casos:", "glossario": "Glosario", "verGlossario": "ver en el glosario"};
  /*L-FIM*/
